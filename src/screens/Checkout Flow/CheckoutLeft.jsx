    ...
    <div className="payment-container">
      ...
      <div className="shipping-details">
        ...
        <div className="full-name-checkout">
            <p> Full Name </p>
            <h5 className="checkout-fullname"> Sallu Roy </h5>
        </div>
        <div className="phone-checkout">
            <p> Phone </p>
            <h5 className="checkout-phone"> 02184548845 </h5>
        </div>
        <div className="Address-checkout">
            <p> Address </p>
            <h5 className="checkout-Address"> 13101 SOUTHAMPTON ST DETROIT MI 48213-3700 USA </h5>
        </div>
