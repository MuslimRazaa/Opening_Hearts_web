...
import image2 from "../../../../media/images/Rectangle 4098.png";
import OtherRelatedServicecard from "./OtherRelatedServicecard";

function SliderTwoDetailPage() {
  ...
  return (
    <div className="slider-wrapper">
      <div className="slider-container">
        <Slider {...settings}>
          <div>
            <OtherRelatedServicecard image={image2} />
          </div>
          <div>
          <OtherRelatedServicecard image={image2} />
...
export default SliderTwoDetailPage;
