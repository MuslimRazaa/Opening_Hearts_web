...
function ServiceListing() {
  ...
  const stores = Array.from({ length: totalItems }, (_, i) => `Provider ${String(i + 1).padStart(2, '0')}`);
        ...
        <div className='container'>
            ...
            <div className="product-listing-dropdown">
                ...
                {isOpen && (
                    ...
                    <div className="product-listing-dropdown-item" onClick={() => handleNavigation('/bussiness-organization')}>Organization</div>
