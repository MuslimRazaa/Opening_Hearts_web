...
import ProductTransactionTable from './DonationTransactionTable'
import ProductBankCardSelect from './DonationBankCardSelect'
import DonationTransactionTable from './DonationTransactionTable'
import DonationBankCardSelect from './DonationBankCardSelect'

const DonationWalletDetails = () => {
            ...
            <div className="wallet-main-class">
                <div className="wallet-card-section">
                    <div className="row">
                        ...
                        <div className="col-md-6">
                           <Link to="/donation-dashboard/amount-balance-wallet-donation" > <div className="wallet-card2">
                                <select className='this-week' id="">
                                    <option value="">This Week</option>
                                    <option value="">1 Week</option>
                                    <option value="">2 Week</option>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-5">
                            {/* card */}
                            <DonationBankCardSelect handleOrderNowClick3={handleOrderNowClick3} />
                        </div>
                    </div>
                </div>
            </div>
...
export default DonationWalletDetails
