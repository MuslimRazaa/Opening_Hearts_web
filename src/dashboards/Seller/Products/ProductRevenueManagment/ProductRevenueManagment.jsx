...
function ProductRevenueManagment() {
    ...
    const handleTableTabchange = (tab) => { setTableTab(tab) }
                    ...
                    <div className='orders-table-and-tabs'>
                        ...
                        <div className='table-tabs-main'>
                            <div className='donation-detail-page-search-bar-table-tab'>
                                ...
                                <input type='search' placeholder='Search..' value={search} onChange={(e) => { setSearch(e.target.value); productOrderManagment(orderType, e.target.value, startDate, endDate) }} />
                            </div>
                                ...
                                <div className="both-side-calendor">
                                    <div className="clander-js">
                                        <div className="calender-dpdown">
                                            ...
                                            <DatePicker
                                                selected={startDate}
                                                onChange={(date) => { setStartDate(formatDate(date)); productOrderManagment(orderType, search, formatDate(date), endDate) }}
                                    ...
                                    <div className="clander-js">
                                        <div className="calender-dpdown">
                                            ...
                                            <DatePicker
                                                selected={endDate}
                                                onChange={(date) => { setEndDate(formatDate(date)); productOrderManagment(orderType, search, startDate, formatDate(date)) }}
                                                dateFormat="yyyy-MM-dd"
                                        ...
                                        {orders?.order?.length > 0 ?
                                            orders?.order?.map((order, index) => (
                                                <div className="table-row" key={index}>
                                                    ...
                                                    <div><span className='delete' onClick={() => { navigate(`/dashboard/produts-revenue-detail?id=${order?.id}`) }}><FaRegEye /></span></div>
                                                </div>
                                            ))
                                            :
...
export default ProductRevenueManagment
