...
import ThemeEditor from '../../Service/SetupYourOffice/ThemeEditor'
...
function ProductDashbaordLayout() {
        ...
        <div>
            ...
            <Modal isVisible={isModalVisible4} onClose={handleCloseModal4}>
                <div className='modal-content-here'>
                    ...
                    <div className="modal-content-buttons">
                        <div className="modal-content-button">
                            <Link to="/dashboard/product" ><button>Go To Dashboard </button></Link>
                        </div>
                    </div>
                </div>
            </Modal>
...
export default ProductDashbaordLayout
