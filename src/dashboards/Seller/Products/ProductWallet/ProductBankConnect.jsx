            ...
            <Modal isVisible={isModalVisible4} onClose={handleCloseModal4}>
                <div className='modal-content-here'>
                    ...
                    <div className="modal-content-buttons">
                        <Link to="/dashboard/wallet-description-product" > <button className='modal-continue-btn'>Continue</button> </Link> 
                    </div>
                </div>
            </Modal>
        </>
...
export default ProductBankConnect
