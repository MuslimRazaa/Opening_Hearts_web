...
function ServiceDashboard() {
    ...
    const getServiceDashboard = async () => {
        setLoading(true)
        try {
            const response = await apis.getServiceDashboard();
    ...
    const handleFormSubmit = async (e) => {
        ...
        if (showFormData?.name != "" && showFormData?.profile_image != "" && showFormData?.cover_image != ""
            ...
            data.append("main_category", JSON.stringify(tempCate));
            try {
                const response = await apis.createStore(data);
    ...
    return (
        <>
            {
                userData.is_service_subscription == 0 ?
                    <>
                        <div>
                                ...
                                <>
                                    <div className="row">
                                        ...
                                        <div className="col-lg-4">
                                            <div className="seller-db-box-TO">
                                                <h3>Total Revenue</h3>
                                                <h2>${dashboard?.total_revenue_order}</h2>
                                                <p>{dashboard?.total_revenue_order_per}% month over month</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-lg-4">
                                            <div className="seller-db-box-TO">
                                                ...
                                                <h2>${dashboard?.total_accept_order}</h2>
                                                <p>{dashboard?.total_accept_order_per}% month over month</p>
                                            </div>
                                        </div>
                                        <div className="col-lg-4">
                                            <div className="seller-db-box-TO">
                                                <h3>Number of Listed Services</h3>
                                                <h2>${dashboard?.total_service}</h2>
                                                <p>{dashboard?.total_service_per}% month over month</p>
                                            </div>
                                        </div>
                                    </div>
