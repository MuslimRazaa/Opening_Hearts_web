...
import ServiceManagmentBarChart from '../../../Charts/ServiceManagmentBarChart';
...
function CompleteServiceSectionTwo() {
                ...
                <div>
                    <div className="row">
                        <div className="col-lg-6">
                            <ServiceManagmentBarChart
                                name={charts?.name}
                                value={charts?.bar_chart_order}
                                totalOrder={charts?.total_order}
                                ProductOrderManagmentChart={serviceDashboardChartData}
                            />
                        </div>
                        <div className="col-lg-6">
                    ...
                    <div className='orders-table-and-tabs'>
                        ...
                        <div className='table-tabs-main'>
                            <div className="tabs-button-wrapper">
                                <button className={orderType === "" ? "active" : ""} onClick={() => { setOrdertype(""); serviceOrderManagment(null, search, startDate, endDate, 1, page_size) }}>All</button>
                                <button className={orderType === "pending" ? "active" : ""} onClick={() => { setOrdertype("pending"); serviceOrderManagment("pending", search, startDate, endDate, 1, page_size) }}>Pending</button>
                                <button className={orderType === "accept" ? "active" : ""} onClick={() => { setOrdertype("accept"); serviceOrderManagment("accept", search, startDate, endDate, 1, page_size) }}>Active</button>
                                <button className={orderType === "complete" ? "active" : ""} onClick={() => { setOrdertype("complete"); serviceOrderManagment("complete", search, startDate, endDate, 1, page_size) }}>Completed</button>
                                {/* <button className={orderType === "refunded" ? "active" : ""} onClick={() => { setOrdertype("refunded"); serviceOrderManagment("refunded", search, startDate, endDate, 1, page_size) }}>Refunded</button> */}
                                <button className={orderType === "cancel" ? "active" : ""} onClick={() => { setOrdertype("cancel"); serviceOrderManagment("cancel", search, startDate, endDate, 1, page_size) }}>Rejected</button>
                            </div>
                            <div className='donation-detail-page-search-bar-table-tab'>
                                <img src={searchIcon} alt="Search icon" />
                                <input type='search' placeholder='Search..' value={search} onChange={(e) => { setSearch(e.target.value); serviceOrderManagment(orderType, e.target.value, startDate, endDate, 1, page_size) }} />
                            </div>
                                ...
                                <div className="both-side-calendor">
                                    <div className="clander-js">
                                        <div className="calender-dpdown">
                                            ...
                                            <DatePicker
                                                selected={startDate}
                                                onChange={(date) => { setStartDate(formatDate(date)); serviceOrderManagment(orderType, search, formatDate(date), endDate, 1, page_size) }}
                                    ...
                                    <div className="clander-js">
                                        <div className="calender-dpdown">
                                            ...
                                            <DatePicker
                                                selected={endDate}
                                                onChange={(date) => { setEndDate(formatDate(date)); serviceOrderManagment(orderType, search, startDate, formatDate(date), 1, page_size) }}
                                                dateFormat="yyyy-MM-dd"
...
export default CompleteServiceSectionTwo
