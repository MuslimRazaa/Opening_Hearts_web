...
function ServiceHelpAndSupport() {
    ...
    const [formData, setFormData] = useState({
        ...
        message: "",
        email: "",
        type: "provider", //user / seller / provider / organization / guest_user
    });
            ...
            setFormData(
                {
                    ...
                    phone: response?.data?.data?.provider?.phone_code + response?.data?.data?.provider?.phone,
...
export default ServiceHelpAndSupport
