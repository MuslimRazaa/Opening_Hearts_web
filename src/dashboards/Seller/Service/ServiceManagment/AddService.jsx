...
function AddService() {
    ...
    const createService = async () => {
        ...
        try {
            const response = await apis.createService(data);
                ...
                <>
                    <div className="add-service-set-packages">
                        <div className="row">
                            ...
                            <div className="col-lg-3">
                                <div className={packageSelection === "B" ? "add-service-set-pack-input-open" : "add-service-set-pack-input"}>
                                    <p>Basic</p>
                                </div>
                            </div>
                            <div className="col-lg-3">
                                <div className={packageSelection === "S" ? "add-service-set-pack-input-open" : "add-service-set-pack-input"}>
                                    <p>Standard</p>
                                </div>
                            </div>
                            <div className="col-lg-3">
                                <div className={packageSelection === "A" ? "add-service-set-pack-input-open" : "add-service-set-pack-input"}>
                                    <p>Advance</p>
                                </div>
                            </div>
                        </div>
            ...
            <div className='add-faq-service-wrapper'>
                ...
                <div className="step-one-button">
                    <div className="seller-service-dashboard-main-right-button">
                        <button style={{ width: "100%" }} disabled={loading} onClick={() => { createService() }}>
                            {loading ? "Laoding..." : "Create Service"}</button>
                    </div>
                </div>
            </div>
        </div>
