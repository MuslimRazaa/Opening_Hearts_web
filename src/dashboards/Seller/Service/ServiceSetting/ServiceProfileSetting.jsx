...
function ServiceProfileSetting() {
    ...
    const getServiceData = async () => {
        try {
            const response = await apis.getServiceData();
            let tempCategory = [];
            for (let i = 0; i < response?.data?.data?.provider?.category?.length; i++) {
                tempCategory.push({ value: response?.data?.data?.provider?.category[i].id, label: response?.data?.data?.provider?.category[i].name })
            }
            console.log(response?.data?.data?.provider?.images.length > 0);

            setShopFormData(
                {
                    name: response?.data?.data?.provider?.store_name,
                    description: response?.data?.data?.provider?.description,
                    address: response?.data?.data?.provider?.street_address,
                    city: response?.data?.data?.provider?.city,
                    country: response?.data?.data?.provider?.country,
                    zip_code: response?.data?.data?.provider?.zip_code,
                    sell: "Service",
                    phone_code: response?.data?.data?.provider?.phone_code,
                    phone_number: response?.data?.data?.provider?.phone,
                    phone_country_code: response?.data?.data?.provider?.phone_country_code,
                    cover_image: response?.data?.data?.provider?.cover_image ? response?.data?.data?.provider?.cover_image : "",
                    edit_cover_image: response?.data?.data?.provider?.cover_image ? true : false,
                    profile_image: response?.data?.data?.provider?.profile_image ? response?.data?.data?.provider?.profile_image : "",
                    edit_profile_image: response?.data?.data?.provider?.profile_image ? true : false,
                    other_images: response?.data?.data?.provider?.images?.length > 0 ? response?.data?.data?.provider?.images : [],
                    video: response?.data?.data?.provider?.video ? response?.data?.data?.provider?.video : "",
                    edit_video: response?.data?.data?.provider?.video ? true : false,
    ...
    const getAllCategories = async (type) => {
        try {
            const response = await apis.getAllCategories(type);
            let temp = [];
    ...
    const handleFormSubmit = async (e) => {
        ...
        if (showFormData?.name != "" && showFormData?.profile_image != "" && showFormData?.cover_image != ""
            ...
            data.append("store_name", showFormData?.name);
            data.append("description", showFormData?.description);
            data.append("street_address", showFormData?.address);
            ...
            data.append("phone", showFormData?.phone_number);
            data.append("business_type", showFormData?.sell);
            ...
            try {
                const response = await apis.updateStore(data);
                getServiceData();
