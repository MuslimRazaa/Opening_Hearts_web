...
function OrganizationNotificationSetting() {
                            ...
                            <div className="toggle-price"
                                onClick={() => {
                                    updateNotificationSetting({
                                        ...
                                        buying_notification: formData?.buying_notification,
                                        selling_notification: formData?.selling_notification,
                                        organization_notification: formData?.organization_notification === 1 ? 0 : 1
                                    })
                                }}
                            >
...
export default OrganizationNotificationSetting
