...
const ProductBankCardSelect = ({handleOrderNowClick3}) => {
        ...
        <>
            <div className='main-Bank-card'>
                ...
                <div className="bank-main-card-btn">
                   <Link to="/product-dashboard/product-bank-connect" ><button type='button' className='btn-last-bank-card'>Add new Bank</button> </Link> 
                </div>
            </div>
        </>
    );
...
export default ProductBankCardSelect;
