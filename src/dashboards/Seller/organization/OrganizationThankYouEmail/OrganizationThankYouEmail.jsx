...
const OrganizationThankYouEmail = () => {
    ...
    const sendOrganizationThankYouMail = async (e) => {
        e.preventDefault()
        setInputError(true);
        ...
        try {
            const response = await apis.sendOrganizationThankYouMail(data);
                ...
                <div className="meal-form">
                    <div className="row">
                        {formData.campaign_id ?
                            <>
                                <form onSubmit={sendOrganizationThankYouMail}>
                                    <div className="create-campaing-top-sec">
                                        <div className="one">
                                            <div className="l">Thank you Emails</div>
                                            <div className="r">{campaignValidation?.thank_you_email_use}/{campaignValidation?.thank_you_email}</div>
                                        </div>
                                        <div className="two">
                                            <div className="l">Note:* With the basic plan your can send upto {campaignValidation?.thank_you_email} blast emails</div>
                                            <div className="r">
                                    ...
                                    <div className="blast-email-campaign">
                                        ...
                                        <Select
                                            ...
                                            className="select-addon-campaign"
                                            isMulti
                                            isOptionDisabled={() => formData.user_id.length >= (campaignValidation?.thank_you_email - campaignValidation?.thank_you_email_use)} // Disable adding new selections
                                        />
                                    ...
                                    <div className="button-email">
                                        <button disabled={campaignValidation?.thank_you_email === campaignValidation?.thank_you_email_use}>{isFromLoading ? "Loading..." : 'Submit'}</button>
                                    </div>
                                </form>
                            </>
                            :
...
export default OrganizationThankYouEmail